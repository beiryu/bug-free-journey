...
var css5 = [
  ...
  '@media (max-width: 809px) and (min-width: 0px) { .framer-vZy50 .framer-1y1a6mn { justify-content: center; overflow: visible; width: 100%; gap: 8px; padding: 20px } }',
  '@media (max-width: 809px) and (min-width: 0px) { .framer-vZy50.framer-15d2p9o { flex-direction: column-reverse; height: 100%; width: 100%; } }',
  '@media (max-width: 809px) and (min-width: 0px) { .framer-vZy50 .framer-vbijyw { flex: 1 1 auto; width: 100%; overflow: visible; } }',
