...
// /:https://framerusercontent.com/modules/km0JtJRF3JqJXshickBM/fj4LjPFLXFzs6Ji1yCdT/TqwI4WrNI.js
...
// /:https://framerusercontent.com/modules/iYz95w6OXy1YVNigizpv/L5ybUNGOenyMzZR8HdJo/oF0l6SR3Q.js
import {
  jsx as _jsx4,
  jsxs as _jsxs2,
...
// /:https://framerusercontent.com/modules/km0JtJRF3JqJXshickBM/fj4LjPFLXFzs6Ji1yCdT/TqwI4WrNI.js
var SectionTeamFonts = getFonts2(stdin_default5);
var cycleOrder4 = ['JA0JBL33K', 'zQ98CoqfI', 'oLUYdZzxp'];
var serializationHash5 = 'framer-aH7Rr';
var variantClassNames5 = {
  JA0JBL33K: 'framer-v-1p1x19n',
  oLUYdZzxp: 'framer-v-19m1cwf',
  zQ98CoqfI: 'framer-v-vhuhi5',
};
...
var transformTemplate12 = (_2, t4) => `translate(-50%, -50%) ${t4}`;
...
var getProps5 = ({ height, id, width, ...props }) => {
  return {
    ...props,
    variant:
      humanReadableVariantMap4[props.variant] ?? props.variant ?? 'JA0JBL33K',
  };
};
        ...
        <Transition5 value={transition15}>
          ...
          >
            <ComponentViewportProvider2
              ...
              y={
                (componentViewport?.y || 0) +
                ((componentViewport?.height || 1169) * 0.49957228400342196 -
                  584.5)
              }
              {...addPropertyOverrides5(
                {
            ...
            >
              <SmartComponentScopedContainer2
                className={'framer-nzzg2-container'}
                isModuleExternal={true}
                layoutDependency={layoutDependency}
                layoutId={'knw2DXmw7-container'}
                nodeId={'knw2DXmw7'}
                rendersWithMotion={true}
                scopeId={'TqwI4WrNI'}
...
var css9 = [
  '@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }',
  '.framer-aH7Rr.framer-9jlxut, .framer-aH7Rr .framer-9jlxut { display: block; }',
  '.framer-aH7Rr.framer-1p1x19n { height: 1169px; overflow: var(--overflow-clip-fallback, clip); position: relative; width: 1200px; }',
  '.framer-aH7Rr .framer-nzzg2-container { flex: none; height: auto; left: 50%; position: absolute; top: 50%; width: 100%; }',
  '.framer-aH7Rr.framer-v-vhuhi5.framer-1p1x19n { height: 1421px; width: 810px; }',
  '.framer-aH7Rr.framer-v-vhuhi5 .framer-nzzg2-container { top: 50%; }',
  '.framer-aH7Rr.framer-v-19m1cwf.framer-1p1x19n { width: 390px; }',
];
var FramerTqwI4WrNI = withCSS5(Component5, css9, 'framer-aH7Rr');
var stdin_default6 = FramerTqwI4WrNI;
FramerTqwI4WrNI.displayName = 'Team';
FramerTqwI4WrNI.defaultProps = {
  height: 1169,
  width: 1200,
};
addPropertyControls5(FramerTqwI4WrNI, {
  variant: {
    options: ['JA0JBL33K', 'zQ98CoqfI', 'oLUYdZzxp'],
